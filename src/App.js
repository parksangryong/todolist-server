...
function App() {
  ...
  const getTodo = async () => {
    const result = await axios.get(
      "https://port-0-todolist-node-kvmh2mljl31rz6.sel4.cloudtype.app/todo"
    );
  ...
  const deleteAll = async () => {
    const result = await axios.delete(
      "https://port-0-todolist-node-kvmh2mljl31rz6.sel4.cloudtype.app/todoall"
    );
    setAle(result);
  };
  ...
  const declearAll = async () => {
    const result = await axios.put(
      "https://port-0-todolist-node-kvmh2mljl31rz6.sel4.cloudtype.app/todoallx"
    );
    setAle(result);
  };
  ...
  const completeTodo = async (num, completestate) => {
    ...
    const result = await axios.put(
      "https://port-0-todolist-node-kvmh2mljl31rz6.sel4.cloudtype.app/todocom",
      todoObj
    );
    setAle(result);
  };
